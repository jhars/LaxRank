...
//   var myTeamsController = {
// ////////////////////////
//     // compile underscore templates
//     template: _.template($('#user-template').html()),
//     myTeamsTemplate: _.template($('#my-teams-template').html()),
// //////////////////////
...
//         $userHtml = $(myTeamsController.template({currentUser: user}));

//         // append user HTML to page
//         $('#show-follows').append($userHtml);

//         // iterate through user's logs
//         _.each(user.follows, function(follow, index) {
//           console.log(follow);
